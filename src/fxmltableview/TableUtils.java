...
public class TableUtils {
    ...
    public static void copySelectionToClipboard(TableView<?> table) {
        ...
        for (TablePosition position : positionList) {
            ...
            if (prevRow == row) {
                ...
                clipboardString.append(repeat('\t', col - prevCol));
                prevCol = col;

            } else if (prevRow != -1) {

                clipboardString.append(repeat('\n', row - prevRow));
                clipboardString.append(repeat('\t', col - startCol));
            } else
            {
                startCol = col;
            }
    ...
    public static void pasteClipboard( TableView<?> table) {
        ...
        while( rowTokenizer.hasMoreTokens()) {
            ...
            StringTokenizer columnTokenizer = new StringTokenizer( rowString, "\t", true);
    ...
    private static String repeat(char c, Integer times)
    {
        String string = "";
